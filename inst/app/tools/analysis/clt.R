...
output$ui_clt <- renderUI({
  tagList(
    ...
    wellPanel(
      selectInput("clt_dist", "Distribution:", 
        choices = clt_dist, 
      ...
      conditionalPanel(condition = "input.clt_dist == 'runif'",
        div(class = "row",
          div(class = "col-xs-6",
            numericInput("clt_unif_min", "Min:", 
              value = state_init("clt_unif_min", 0)
            )
          ),
          div(class="col-xs-6",
            numericInput("clt_unif_max", "Max:", 
      ...
      conditionalPanel(condition = "input.clt_dist == 'rnorm'",
        div(class = "row",
          div(class = "col-xs-6",
            numericInput("clt_norm_mean", "Mean:", 
              value = state_init("clt_norm_mean", 0)
            )
          ),
          div(class = "col-xs-6",
            numericInput("clt_norm_sd", "SD:", 
      ...
      conditionalPanel(condition = "input.clt_dist == 'expo'",
        numericInput("clt_expo_rate", "Rate:", 
      ...
      conditionalPanel(condition = "input.clt_dist == 'binom'",
        div(class = "row",
          div(class = "col-xs-6",
            numericInput("clt_binom_size", "Size:", 
              value = state_init("clt_binom_size", 5), 
              min = 1, max = 100, step = 1
            )
          ),
          div(class = "col-xs-6",
            numericInput("clt_binom_prob", "Prob:", 
      ...
      div(class = "row",
          div(class = "col-xs-6",
            numericInput("clt_n", "Sample size:",  
              value = state_init("clt_n", 100), 
              min = 2, step = 1
            )
          ),
          div(class = "col-xs-6",
            numericInput("clt_m", "# of samples:", 
